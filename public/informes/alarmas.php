<?php
/**
 * alarmas.php (Informe de Distribución de Alarmas)
 * Ubicación: /var/www/html/VILASECA/CMDBPRnew/public/informes/alarmas.php
 */
...
$page_title = 'Distribución de Alarmas';
require_once __DIR__ . '/../partials/header.php';

// Obtener parámetros si vienen de drill-down u otros informes
...
<div class="container-fluid pt-2">
    ...
    <div class="nav-report-tabs d-flex align-items-center">
        ...
        <a href="alarmas.php" class="nav-report-link active mr-3"><i class="fas fa-exclamation-triangle mr-2"></i>Distribución de Alarmas</a>
    ...
    <div class="card filter-card mb-4">
        ...
        <div class="card-body">
            ...
            <div id="loading-message" class="text-center text-primary font-weight-bold my-3" style="display: none;">
                <i class="fas fa-spinner fa-spin mr-2"></i> Generando informe de alarmas, por favor espere...
            </div>
...
<script src="display_alarmas.js"></script>
...
<script>
    $(function() {
        ...
        reportForm.addEventListener('submit', async (event) => {
            ...
            try {
                const response = await fetch('process_alarmas.php', {
                    method: 'POST',
                ...
                renderAlarmReport(data, reportContainer); 
        ...
        pdfExportButton.addEventListener('click', async () => {
            ...
            try {
                ...
                html2canvas(element, {
                    ...
                    const startDate = $('#startDatePicker').val();
                    const endDate = $('#endDatePicker').val();
                    doc.save(`Informe_Alarmas_${groupName}_${startDate}_a_${endDate}.pdf`);
                });
            } catch(error) {
