...
if ($data['hosts']) {
    ...
    foreach ($data['hosts'] as $host) {
        ...
        if ($savings_percentage > 80) {
            $savings_cell->addClass('savings-high');
        } elseif ($savings_percentage > 50) {
            $savings_cell->addClass('savings-medium');
        } elseif ($savings_percentage > 20) {
            $savings_cell->addClass('savings-low');
        } else {
            $savings_cell->addClass('savings-minimal');
        }
