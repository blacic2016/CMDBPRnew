...
<head>
    ...
    <title>Wi-Fi Monitor Pro | Zabbix Integration</title>
...
<body>
        ...
        <main>
            ...
            <section id="ap-analysis" class="tab-content">
                <div class="analysis-layout">
                    ...
                    <!-- Sidebar Area (Diagnostic & Recommendation Detail) -->
    ...
    <script src="js/topology.js?v=<?php echo time(); ?>"></script>
    <script src="js/trajectory.js?v=<?php echo time(); ?>"></script>
    <script src="js/ap_analysis.js?v=<?php echo time(); ?>"></script>
    <script src="js/heatmap.js?v=<?php echo time(); ?>"></script>
    <script src="js/floor_config.js?v=<?php echo time(); ?>"></script>
    <script src="js/topology_2d.js?v=<?php echo time(); ?>"></script>
</body>
</html>
